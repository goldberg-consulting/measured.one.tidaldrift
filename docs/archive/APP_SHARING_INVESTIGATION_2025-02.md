> **Historical investigation — superseded.** This note preserves the original February 2025 investigation and its May 2026 status update. It contains findings and recommendations that no longer describe the current implementation, including contradictory statements about loading failures and PID validation. Use the [LocalCast guide](../LOCALCAST.md) for current workflows and behavior.
